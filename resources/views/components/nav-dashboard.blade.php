    ...
    <div class="d-flex">
        ...
        <div class="navbar-brand-box text-center">
            <a href="{{ route('admin.dashboard.index') }}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('dashboard/images/logo-sm.png') }}" alt="logo-sm-dark" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('dashboard/images/logo-dark.png') }}" alt="logo-dark" height="24">
                </span>
            </a>
            ...
            <a href="{{ route('admin.dashboard.index') }}" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('dashboard/images/logo-light.png') }}" alt="logo-light" height="24">
                </span>
            </a>
        </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault; document.getElementById('logout').submit();"><i
